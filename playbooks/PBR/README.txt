...
There are total 3 files used for this use-case.
  1. PBR_variable.txt:
	 ...
	 - volume* 		: Parameters starting volume contain details for volume such as name prefix for volume ,volume group and size for the volumes to be created.
